...
const eventSources = [
  ...
  { key: "capability.execution.created", label: "Capability Execution Created", description: "The Universal Capability Runtime created an immutable execution session." },
  { key: "capability.execution.started", label: "Capability Execution Started", description: "A capability execution entered the running state." },
  { key: "capability.execution.completed", label: "Capability Execution Completed", description: "A capability execution reached its completed terminal state." },
  { key: "capability.execution.failed", label: "Capability Execution Failed", description: "A capability execution reached its failed terminal state." },
  { key: "capability.execution.pipeline.started", label: "Capability Execution Pipeline Started", description: "The canonical capability execution pipeline started." },
  { key: "capability.execution.stage.started", label: "Capability Execution Stage Started", description: "A canonical capability execution stage started." },
  { key: "capability.execution.stage.completed", label: "Capability Execution Stage Completed", description: "A canonical capability execution stage completed." },
  { key: "capability.execution.pipeline.completed", label: "Capability Execution Pipeline Completed", description: "The canonical capability execution pipeline completed." },
  { key: "capability.execution.pipeline.failed", label: "Capability Execution Pipeline Failed", description: "The canonical capability execution pipeline failed at a known stage." },
