...
export function seedWorkspace(): void {
  workspaceRegistry.register({
    key: "acct_accounting_firm_workspace",
    label: "Accounting Firm Operations",
    description: "Engagement lifecycle, billing efficiency, and client retention for accounting and bookkeeping practices",
    layout: "operational",
    modules: [
    ...
    primaryMetricKey: "acct_billable_hours_pct",
