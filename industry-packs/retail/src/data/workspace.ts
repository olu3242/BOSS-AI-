...
export function seedWorkspace(): void {
  workspaceRegistry.register({
    key: "retail_store_workspace",
    label: "Store Performance",
    description: "Daily retail performance view: gross margin, inventory health, conversion, and customer loyalty metrics.",
    layout: "operational",
    modules: [
    ...
    primaryMetricKey: "retail_gross_margin_pct",
