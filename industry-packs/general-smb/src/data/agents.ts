...
const businessMetadataByAgent = {
  ...
  bte_orchestrator: {
    department: "operations",
    departmentName: "Operations",
    businessDomain: "operational_excellence",
    businessDomainName: "Operational Excellence",
    primaryRole: "Business Operations Orchestrator",
    secondaryRoles: ["Execution Coordinator", "Automation Manager"],
    businessOutcome: "Daily operating loops run reliably and surface what needs attention.",
    businessObjectives: ["Improve cycle reliability", "Reduce manual coordination overhead"],
    priority: "high",
    supportedChannels: ["dashboard", "workflow"],
    tags: ["operations", "automation", "orchestration"],
  },
  marketplace_advisor: {
    department: "sales",
    departmentName: "Sales",
    businessDomain: "growth_strategy",
    businessDomainName: "Growth Strategy",
    primaryRole: "Marketplace Advisor",
    secondaryRoles: ["Pack Recommendation Specialist"],
    businessOutcome: "The business adopts the right capabilities at the right time.",
    businessObjectives: ["Improve adoption fit", "Surface timely growth recommendations"],
    priority: "medium",
    supportedChannels: ["dashboard", "messaging"],
    tags: ["marketplace", "growth", "recommendations"],
  },
  onboarding_coach: {
    department: "customer_success",
    departmentName: "Customer Success",
    businessDomain: "customer_onboarding",
    businessDomainName: "Customer Onboarding",
    primaryRole: "Onboarding Coach",
    secondaryRoles: ["Implementation Guide"],
    businessOutcome: "New businesses reach first value quickly and confidently.",
    businessObjectives: ["Improve time-to-first-value", "Reduce onboarding friction"],
    priority: "high",
    supportedChannels: ["messaging", "dashboard"],
    tags: ["onboarding", "activation", "customer_success"],
  },
...
const workflowKeysByAgent = {
  ...
  ai_reporting_analyst: [],
  bte_orchestrator: ["administrative_automation"],
  marketplace_advisor: [],
  onboarding_coach: [],
} as const satisfies Record<
  (typeof aiEmployees)[number]["key"],
